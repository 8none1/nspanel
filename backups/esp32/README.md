This directory would contain a backup of the original nspanel ESP32 firmware.  It's a dump of the full 4MB flash and can be used to restore the ESP32 part of the NSPanel back to the factory state.
